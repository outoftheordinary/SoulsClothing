...
<body>
    ...
    <?php if ($showForm): ?>
        <form method="POST" action="checkout.php" role="form" aria-description="form for checkout">
            ...
            <button type="submit" role="button" aria-description="button to place order">Place Order</button>
        </form>
    <?php elseif ($showConfirmation): ?>
        <div class="confirmation">
            <h2>Order Confirmation</h2>
            <p>Hey <?php echo $name ?>, your order will be shipped to <?php echo $address ?>.</p>
            <h3>Your Items:</h3>
            <ul>
